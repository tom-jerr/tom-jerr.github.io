...
cover: img/blog-posts/parallelization_kv.gif
aliases:
  - blogs/posts/FlashAttention 原理 v1-v2
---
...
![](img/blog-posts/flash_motivation.png)
...
![](img/blog-posts/fla_attn_motivation.png)
...
![](img/blog-posts/tile_softmax.png)
...
![](img/blog-posts/safe_softmax.png)
...
- 我们可以只在一次循环中计算出 $m_i$ 和 $d_i$，而不需要先计算出完整的 $m$ 和 $d$。
  ...
  ![](img/blog-posts/online_softmax.png)
...
![](img/blog-posts/flash_attn_v1.png)
...
- 所有我们接下来可以找 $o_i$ 的递推公式，只用一个循环实现部分的更新(max，d，o)
  ...
  ![](img/blog-posts/self_attentionv2.png)
...
![](img/blog-posts/flash_attention_algo.png)
...
![](img/blog-posts/tiling_flash_attention.png)
...
![alt text](img/blog-posts/flashattentionv2.png)
...
![](img/blog-posts/flash_v2_warp.jpg)
...
![](img/blog-posts/causal_mask.jpg)
...
![](img/blog-posts/parallelization_kv.gif)
