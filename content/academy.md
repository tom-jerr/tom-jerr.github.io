---
title: 刘芷溢 (Zhiyi Liu)
description: 刘芷溢的教育背景、研究兴趣、项目经历与荣誉奖项。
hide:
  - navigation
  - toc
  - feedback
...
<img src="img/touxiang.png" alt="刘芷溢" class="academy-avatar">

<!--:fontawesome-solid-building: Office: [424, 60 5th Ave, New York, NY 10011](https://maps.app.goo.gl/N7m2fM5EbM3TToB79)-->

📮 工作邮箱: [lzy [underline] CS [underline] LN [at] 163 [dot] com](mailto:lzy_CS_LN@163.com)

📮 个人邮箱: [tomlzy213 [at] gmail [dot] com](mailto:tomlzy213@gmail.com)

<!-- :material-file: 旧版简历: [点击查看](assets/CV_zh.pdf) -->

📄 简历: [点击查看](assets/lzycv.pdf)

<span style="font-size:1.2em;">[GitHub](https://github.com/tom-jerr/) · [X](https://x.com/tom_jerry_jack) · [知乎](https://www.zhihu.com/people/chen-wen-de-jian-ke)</span>
...
> [!INFO] 目前**正在寻找与大模型推理加速相关的秋招机会**，如果您有相关岗位或线索，欢迎随时联系我！最新介绍已整合至[首页](./index.md)。
...
<img src="img/UESTC.png" alt="电子科技大学" class="academy-logo">
...
**开源暑期项目 — Nebula Graph (2025.07 – 2025.10)**（原站未包含证书 PDF 文件）
