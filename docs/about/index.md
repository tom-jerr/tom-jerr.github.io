...
=== "中文"
    ...
    我对分布式数据库、大模型推理等领域很有热情，也喜欢分享自己的学习经验和思考🤓。如果感兴趣，可以看看我的 [Database 学习经验](https://tom-jerr.github.io/DB_Study/) 或 [C++ 学习经验](https://tom-jerr.github.io/CXX_Study/)，也许会找到一些对你有帮助的内容。
...
=== "English"
    ...
    I am passionate about distributed database and llm interferce, and I enjoy sharing my learning experiences and insights🤓. You can check out my [Database study](https://tom-jerr.github.io/DB_Study/) or [C++ study](https://tom-jerr.github.io/CXX_Study/) (both in Chinese) for useful resources.
