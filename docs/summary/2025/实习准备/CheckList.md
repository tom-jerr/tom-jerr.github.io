...
2. **引擎：** SGLang 架构 / RadixAttention / Scheduler
    
3. **算子：** Softmax / LayerNorm / Attention (Triton & CUDA)
    
4. **并行：** TP / PP / EP (MoE) / 通信原语
    
5. **量化：** W8A8 / W4A16 / KV Cache Int8
    
6. **工具：** Nsight Systems / Roofline Model
    
7. **前沿：** Speculative Decoding / PD 分离 / CUDA Graphs
